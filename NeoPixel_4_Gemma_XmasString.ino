...
// READ NOTE BELOW ABOUT ADDING RESISTOR.  Plenty bright with a 470R.
...
void setup() {
  ...
  strip.begin();
  strip.setBrightness(10); //adjust brightness here 0 - 255
